    ...
    <div className="flex flex-col min-h-screen">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">Desenvolvido por: Marcelino Neto - NLW Rocketseat</span>
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4" >
          ...
          <p>
            Lembre-se: você pode utilizar a variável <code className="text-green-400">{'{transcription}'}</code> no seu prompt para adicionar
